    ...
    public void onMessageReceived(MessageReceivedEvent event){
        ...
        if(message[0].equalsIgnoreCase("/toggle") && message.length ==1){
            event.getChannel().sendMessage("To use this command, do:\n/toggle filter").queue();
                ...
                message[1].equalsIgnoreCase("filter") && message.length ==2  && filterOnOff == false){
            eb.setTitle("PROFANITY FILTER HAS BEEN ENABLED");
            eb.setDescription("With the profanity filter enabled, we maintain a realm of respect and decorum, befitting " +
            ...
            filterOnOff =true;
                ...
                message[1].equalsIgnoreCase("filter") && message.length ==2  && filterOnOff == true){
            eb.setTitle("PROFANITY FILTER HAS BEEN DISABLED");
            eb.setDescription("The profanity filter has been deactivated,allowing more expressive communication. However, " +
